...
EPAair_O3_NC2018_raw$Date <- ymd(EPAair_O3_NC2018_raw$Date)
class(EPAair_O3_NC2018_raw$Date)

class(EPAair_O3_NC2019_raw$Date)
EPAair_O3_NC2019_raw$Date <- ymd(EPAair_O3_NC2019_raw$Date)
class(EPAair_O3_NC2019_raw$Date)

class(EPAair_PM25_NC2018_raw$Date)
EPAair_PM25_NC2018_raw$Date <- ymd(EPAair_PM25_NC2018_raw$Date)
class(EPAair_PM25_NC2018_raw$Date)

class(EPAair_PM25_NC2019_raw$Date)
EPAair_PM25_NC2019_raw$Date <- ymd(EPAair_PM25_NC2019_raw$Date)
class(EPAair_PM25_NC2019_raw$Date)
