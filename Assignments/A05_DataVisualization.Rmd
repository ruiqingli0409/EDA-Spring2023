...
Plot.Niwot.Ridge.litter <- ggplot(Niwot.Ridge.litter) +
  geom_point(aes(x = collectDate, y = dryMass)) +
  mytheme.A5
print(Plot.Niwot.Ridge.litter)

theme_set(mytheme.A5)

Plot.PeterPaul.chem.nutrients <- ggplot(PeterPaul.chem.nutrients) +
  geom_point(aes(x = sampledate, y = temperature_C)) +
  mytheme.A5
print(Plot.PeterPaul.chem.nutrients)
```
